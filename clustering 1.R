...
###Verify the data
colnames(data)
sapply(data,class) #class of all columns
class(data$Age)
...
k1 <- amap::Kmeans(data[,-1],centers=3, iter.max = 200) # :: reminds that the operator kmeans belongs to amap, coz kmeans is also available for base pakage
